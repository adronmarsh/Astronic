    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-12 col-md-8">
                <div>
                    <a href="{{ route('shop', $user->id) }}" class="btn btn-link"><i class="fas fa-arrow-left"></i> Volver atrás</a>
                            ...
                            <div>
                                ...
                                <form class="d-flex" action="{{ route('cart.update', $cart->id) }}" method="POST">
                                    ...
                                    <div class="input-group">
                                        <select name="quantity" id="quantity" class="form-control form-control-sm text-center" onchange="this.form.submit()">
                                            @for ($i = 1; $i <= 10; $i++)
